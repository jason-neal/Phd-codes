...
def _parser():
    ...
    #                    help='Ouput Filename',)
    parser.add_argument('-t', '--telluric', action='store', default=False,
                       help='Telluric line Calibrator' )
    parser.add_argument('-m', '--model', action='store', default=False,
                       help='Stellar Model' )
...
# Load Model
    ...
    RV, drvs, cc, drvs, g = ccf_astro((wl, I), (w_mod, I_mod), rvmin=-50, rvmax=50, drv=1)

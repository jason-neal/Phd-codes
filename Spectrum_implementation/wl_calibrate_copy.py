...
def save_calibration_coords(
    ...
    with open(filename, "w") as f:
        ...
        for pixel, obs_depth, obs_std, wl, wl_depth, wl_std in zip(
...
def main(fname, output=None, telluric=None, model=None, ref=None, berv_corr=False):
    ...
    if test0:
        ...
        print(
            "Unrecgonized input filename. Can take ouput from sumnormnodcycle8jn.cl, normalizeobsrsum.cl or Combine_nod_spectra.py"
        )
    ...
    if ans in ["yes", "y", "Yes", "YES"]:
        ...
        #
        Finetuned_wl, finetuned_params = XCorrWaveCal.wl_xcorr(
            (calibrated_wl, uncalib_data[1]),
    ...
    if ans in ["yes", "y", "Yes", "YES"]:
        ...
        save_calibration_coords(
            coord_txt_fname, good_a, std_a, peaks_a, good_b, peaks_b, std_a
        )

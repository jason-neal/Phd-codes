...
# Load data
Chipnames = [
    "Coordinates_CRIRE.2012-04-07T00:08:29.976_1.nod.ms.norm.sum.txt",
    "Coordinates_CRIRE.2012-04-07T00:08:29.976_2.nod.ms.norm.sum.txt",
    "Coordinates_CRIRE.2012-04-07T00:08:29.976_3.nod.ms.norm.sum.txt",
    "Coordinates_CRIRE.2012-04-07T00:08:29.976_4.nod.ms.norm.sum.txt",
]
...
Path = (
    "/home/jneal/Phd/data/Crires/BDs-DRACS/HD30501-1/Fullreductionr-test-1dec2015/Combined_Nods/"
)

Chipnames = [
    "CRIRE.2012-04-07T00:08:29.976_1.nod.ms.norm.sum.fits",
    "CRIRE.2012-04-07T00:08:29.976_2.nod.ms.norm.sum.fits",
    "CRIRE.2012-04-07T00:08:29.976_3.nod.ms.norm.sum.fits",
    "CRIRE.2012-04-07T00:08:29.976_4.nod.ms.norm.sum.fits",
]
...
Combined_pxls = np.concatenate(
    (pix1, pix2 + 1 * 1024, pix3 + 2 * 1024, pix4 + 3 * 1024)
)
...
out_with_depths = minimize(
    residual_depthweighted, params, args=(Combined_pxls, Combined_wls, Combined_depths)
)
...
print(
    "Fitted Gaps with Depths\n Gap1 = {0}\nGap2 = {1}\nGap3 = {2}\n".format(
        Gap1_depths, Gap2_depths, Gap3_depths
    )
)
...
for num, cname in enumerate(Chipnames):
    ...
    plt.plot(
        ...
        Chip_data,
        "--",
        label="Individual Map Chip {}".format(num + 1),
    )
    ...
    plt.plot(
        Chip_wl_comb_depths,
        Chip_data,
        label="Combined depths Map Chip {}".format(num + 1),
    )

...
print(data2[0])
params1 = [
    hdr1["HIERARCH PIXELMAP PARAM1"],
    hdr1["HIERARCH PIXELMAP PARAM2"],
    hdr1["HIERARCH PIXELMAP PARAM3"],
]
params2 = [
    hdr2["HIERARCH PIXELMAP PARAM1"],
    hdr2["HIERARCH PIXELMAP PARAM2"],
    hdr2["HIERARCH PIXELMAP PARAM3"],
]
...
plt.plot(
    pxl[1:],
    wlmap_diff[1:] / (wlmap1[:-1] - wlmap1[1:]),
    "k",
    label="percent  wl map equation diff",
)
